...
`notes` (string, optional) | **Success (202):**`{ "id": "123", "name": "updated_name", "last_modified": "2024-11-20" }`**Error (400):**`{"error": "missing_parameter", "message": "Name is required." }` | write |
| **POST** /files | `name` (string, required) `notes` (string, optional) | **Success (201):**  
`{ "id": "124", "name":"file2", "date_added": "2024-11-22", "size": 0, "is_deleted": false, "permalink": "http://..." }`**Error (400):**`{ "error":"invalid_parameter", "message": "Name is required." }` | write |
